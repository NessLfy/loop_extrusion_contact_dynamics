...
def main():
    ...
    k = [(im[frame,:,channel,...],f"{output_path}_{frame}_{channel}.csv",frame,channel,labels[frame,...],args.crop_size_xy,args.crop_size_z) for frame in range(n_frames) for channel in range(2)]
